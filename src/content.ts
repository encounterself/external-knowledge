...
import { baselineCards } from './generated-baseline-cards';

export type Card = { id: string; title: string; chapter: string; tags: string[]; body: string; prompt?: string; answer?: string; source?: { file: string; startPage: number; endPage: number; anchor: string }; sourcePages?: [number, number]; sourceAnchor?: string };
